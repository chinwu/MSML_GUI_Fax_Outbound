 ...
 *       &lt;attribute name="clamp" type="{}boolean.datatype" default="false" />
    ...
    extends PrimitiveType
{
    ...
    @XmlAttribute(name = "clamp")
    protected BooleanDatatype clamp;
    ...
    /**
     * Gets the value of the clamp property.
     * 
     * @return
     *     possible object is
     *     {@link BooleanDatatype }
     *     
     */
    public BooleanDatatype getClamp() {
        if (clamp == null) {
            return BooleanDatatype.FALSE;
        } else {
            return clamp;
    ...
    /**
     * Sets the value of the clamp property.
     * 
     * @param value
     *     allowed object is
     *     {@link BooleanDatatype }
     *     
     */
    public void setClamp(BooleanDatatype value) {
        this.clamp = value;
    }
    ...
    public static class Recordexit {
        ...
        protected List<XmsMsml.Send> send;
         ...
         * 
         */
        public List<XmsMsml.Send> getSend() {
            if (send == null) {
                send = new ArrayList<XmsMsml.Send>();
            }
            return this.send;
        }
